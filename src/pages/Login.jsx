        ...
        <div className="border-[1px] border-gray-500/20 rounded shadow pt-[46px] pl-[37px] pr-[37px] pb-[28px] mt-[133px] mx-[16px]">
          ...
          <div>
            <form className="w-[344px]">
              <label className="block mb-2 font-bold text-[#595959]">Email</label>
              <input
                type="text"
                className="bg-gray-500/15 rounded-[8px] h-[54px] w-[344px] outline-transparent border-[1px] border-[#D9D9D9]"
              />

              <label className="block mt-[30px] mb-2 font-bold text-[#595959]">Senha</label>
              <input
                type="password"
                className="bg-gray-500/15 rounded-[8px] h-[54px] w-[344px] outline-transparent border-[1px] border-[#D9D9D9]"
              />
              ...
              <button className="w-[344px] h-[50px] bg-[#E04300] rounded-[8px] text-[#FFFFFF]">
                Entrar
              </button>
            </form>
          </div>
